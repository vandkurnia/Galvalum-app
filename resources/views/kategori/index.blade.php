                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-primary btn-sm"
                                            onclick="funcEditUser('{{ route('kategori.edit', ['id' => $ktg->id_kategori]) }}')"><i
                                                class="fas fa-edit"></i>
                                            Edit</button>
                                        <button class="btn btn-danger btn-sm"
                                            onclick="funcHapusUser('{{ route('kategori.destroy', ['id' => $ktg->id_kategori]) }}', 0)"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('kategori.simpan') }}" id="formTambahUser" method="POST">
                    @csrf
