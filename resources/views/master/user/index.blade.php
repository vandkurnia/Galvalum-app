                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-sm"
                                            onclick="funcHapusUser('{{ route('user.destroy', ['id' => $user->hash_id_admin]) }}', 0)"><i
            ...
            <div class="modal-body">
                <form action="{{ route('user.store') }}" id="formTambahUser" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_admin_store" name="nama_admin" required>
                    </div>
                    <div class="form-group">
                        <label for="no_telp_admin" class="form-label">Nomor Telepon Admin</label>
                        <input type="text" class="form-control" id="no_telp_admin_store" name="no_telp_admin"
                            required>
                    </div>
...
@section('javascript-custom')
    ...
    <script>
        ...
        function funcEditUser(id_user) {
            var url = '/user/edit/' + id_user;
