    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Pemasok Barang</h6>
            </div>
            <div class="card-body">
                <div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pemasokbarang.store') }}" id="formTambahUser" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="nama_pemasok" class="form-label">Nama Pemasok</label>
                        <input type="text" class="form-control" id="nama_pemasok_store" name="nama_pemasok" required>
                    </div>
                    <div class="form-group">
                        <label for="no_telp_pemasok" class="form-label">Nomor Telepon Pemasok</label>
                        <input type="text" class="form-control" id="no_telp_pemasok_store" name="no_telp_pemasok"
                            required>
                    </div>
