                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type="number" oninput="totalPembayaran()"
                                            class="form-control" name="diskon_total" id="diskonTotal" value="0">
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <form action="{{ route('pemesanan.store') }}" id="formPembeli" method="POST">
                        ...
                        <div id="formCicilan" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <input oninput="totalPembayaran()" type="number" class="form-control"
                                    name="dp" min="0" id="nilaiDp" value="0">
                            </div>
