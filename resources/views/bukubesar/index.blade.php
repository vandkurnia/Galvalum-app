            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($dataBukuBesar as $bukubesar)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $bukubesar->tanggal }}</td>
                                    <td>{{ $bukubesar->kategori }}</td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-primary btn-sm"
                                            onclick="funcEditUser('{{ route('bukubesar.edit', ['id' => $bukubesar->hash_id_bukubesar]) }}')"><i
                                                class="fas fa-edit"></i>
                                            Edit</button>
                                        <button class="btn btn-danger btn-sm"
                                            onclick="funcHapusUser('{{ route('bukubesar.destroy', ['id' => $bukubesar->hash_id_bukubesar]) }}', 0)"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Bukubesar</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('bukubesar.store') }}" id="formTambahUser" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="tipe_bukubesar">Tipe Bukubesar</label>
                        <select class="form-control" id="tipe_bukubesar" name="tipe_bukubesar">
...
<div class="modal fade" id="EditUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Bukubesar</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
