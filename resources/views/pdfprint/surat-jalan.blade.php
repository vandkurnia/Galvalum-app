        ...
        <div class="right-header">
            <div style="display: flex;flex-direction: row;">
                ...
                <span class="isian-tanggal"
                    style="border-bottom: 1px dotted; margin-left: 5px; width: 100%">{{ $formatTanggal }}</span>
            </div>
    ...
    <section class="content">
        ...
        <div style=" display: flex;justify-content: space-around;height: 120px;margin-top:2rem">
            <div class="tanda-terima">
                ...
                <p style="padding-top: 30px;text-align: center; border-bottom: 1px dotted;">{{ $dataPembeli[0]['nama'] }}</p>
            </div>
            <div class="hormat-kami" style="">
                <h2>Hormat Kami</h2>
