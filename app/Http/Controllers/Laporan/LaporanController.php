...
class LaporanController extends Controller
{
    ...
    public function laporanOmzet(Request $request)
    {
        ...
        WHERE 
            DATE(nota_pembelis.tanggal_penyelesaian) = ? AND ((nota_pembelis.total = (nota_pembelis.nominal_terbayar + nota_pembelis.dp)) OR (nota_pembelis.total < (nota_pembelis.nominal_terbayar + nota_pembelis.dp))  )
        GROUP BY 
    ...
    public function laporanHutang(Request $request)
    {
        ...
        $dataLaporanHutang = DB::select(
            '
                ...
                WHERE (lacak_stok.nominal_terbayar + lacak_stok.dp) < lacak_stok.total AND lacak_stok.deleted_at IS NULL
                ',
            []
        );
        // $dataLaporanHutang = DB::select(
