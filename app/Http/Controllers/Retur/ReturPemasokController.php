...
class ReturPemasokController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            foreach ($returData as $item) {
                ...
                $barang->stok_seluruh = $barang->stok_seluruh  - $item['qty'];
    ...
    public function destroy($id_retur)
    {
        ...
        if ($dataRetur) {
            ...
            $barang->stok_seluruh = $barang->stok_seluruh + $dataRetur->qty;
            ...
            $hutangDanStok->total = $hutangDanStok->stok * $hutangDanStok->harga_beli;
            $hutangDanStok->save();
